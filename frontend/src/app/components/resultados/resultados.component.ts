...
export class ResultadosComponent implements OnInit {
  ...
  verRevision(intento: any) {
    ...
    // Intentamos extraer el corazón del circuito
    let circuitoLimpio = intento.detalle_ejercicio.circuito;

    // Si Django lo guardó doblemente anidado, lo extraemos
    if (circuitoLimpio && circuitoLimpio.circuito) {
      circuitoLimpio = circuitoLimpio.circuito;
    }

    const dataRevision = {
      circuito: circuitoLimpio,
