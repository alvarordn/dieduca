  ...
  export class NavbarComponent {
    // Inicializamos los bloques que habrá disponibles
    bloques = [
    ...
    ngOnInit() {
      ...
      // Nos suscribimos para saber si entra o sale el usuario en tiempo real
      this.authService.uvus$.subscribe((uvus) => {

        // Si hay uvus lo formateamos
        if (uvus) {
          this.nombreUsuario =
          ...
          // Si hay token obtenemos el id del Usuario
          if (token) {
            try {
