    ...
    secciones: [
      {
        ...
        contenido: 'La Ley de Ohm establece que $V = I \\cdot R$. Ohm descubrió que la corriente que fluye por un conductor es proporcional a la diferencia de potencial.',
      ...
      },
      {
        ...
        contenido: 'Elementos que almacenan energía en campos eléctricos ($W = \\frac{1}{2}CV^2$) y magnéticos ($W = \\frac{1}{2}LI^2$). Faraday sentó las bases de la inducción electromagnética.',
    ...
    secciones: [
      {
        ...
        contenido: 'Basado en la aplicación sistemática de la LKC. Maxwell unificó el análisis de redes permitiendo resolver circuitos de gran complejidad.',
      ...
      },
      {
        ...
        contenido: 'Basado en la aplicación de la LKT. El análisis de mallas utiliza la corriente como variable fundamental, nombrada Amperio en su honor.',
    ...
    secciones: [
      {
        ...
        contenido: 'Cualquier red lineal puede sustituirse por una fuente de tensión $V_{th}$ en serie con una $R_{th}$. Thévenin fue un ingeniero clave en la telegrafía francesa.',
      ...
      },
      {
        ...
        contenido: 'La respuesta de un circuito lineal con varias fuentes es la suma de las individuales. Norton extendió estos conceptos para crear equivalentes de corriente.',
    ...
    secciones: [
      {
        ...
        contenido: 'Representación mediante números complejos. Steinmetz permitió que la ingeniería eléctrica pasara de cálculos infernales a aritmética compleja sencilla.',
      ...
      },
      {
        ...
        contenido: 'Relación $\\mathbf{V} = \\mathbf{I} \\cdot \\mathbf{Z}$. Tesla fue el mayor promotor del sistema de corriente alterna que analizamos fasorialmente.',
